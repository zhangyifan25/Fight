...
parser.add_argument("--data_folder", default='./potsdam', type=str, help="dataset folder")
parser.add_argument("--list_folder", default='./datasets/potsdam', type=str, help="train/val/test list file")
...
parser.add_argument("--work_dir", default="work_dir_potsdam", type=str, help="work_dir_potsdam_wseg")
...
parser.add_argument("--start_eval_iters", default=7000, type=int, help="iters to start validation")

parser.add_argument("--high_thre", default=0.7, type=float, help="high_bkg_score")
parser.add_argument("--low_thre", default=0.05, type=float, help="low_bkg_score")
...
parser.add_argument("--bkg_proto_path", default='./background_prototypes/vision_prototypes.pth', type=str, help="bkg proto_path")
parser.add_argument("--bkg_threshold", default=0.8, type=float, help="sim")
        ...
        if (n_iter + 1) >= args.start_eval_iters and (n_iter + 1 - args.start_eval_iters) % args.eval_iters == 0:
            ...
            if args.save_ckpt and (n_iter + 1) >= 7000 and mIoU_result[3] > mIoU:
                ...
                ckpt_name = os.path.join(args.ckpt_dir,
                                         "Best mIoU: {}, model: {} model_iter_%d.pth".format(mIoU, "potsdam") % (
                                                 n_iter + 1))
