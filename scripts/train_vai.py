...
parser.add_argument("--data_folder", default='./vai', type=str, help="dataset folder")
parser.add_argument("--list_folder", default='./datasets/vai', type=str, help="train/val/test list file")
...
parser.add_argument("--work_dir", default="work_dir_vai", type=str, help="work_dir_vai_wseg")
        ...
        if (n_iter + 1) >= args.start_eval_iters and (n_iter + 1 - args.start_eval_iters) % args.eval_iters == 0:
            ...
            if args.save_ckpt and (n_iter + 1) >= 7000 and mIoU_result[3] > mIoU:
                ...
                ckpt_name = os.path.join(args.ckpt_dir,
                                         "Best mIoU: {}, model: {} model_iter_%d.pth".format(mIoU, "vai") % (
                                                 n_iter + 1))
